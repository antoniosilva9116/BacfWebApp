 ...
 */
@Stateless
@Path("persistence.entities.noticia")
public class NoticiaFacadeREST extends AbstractFacade<Noticia> {
    ...
    public void create(Noticia entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Integer id, Noticia entity) {
        super.edit(entity);
    }
    ...
    public Noticia find(@PathParam("id") Integer id) {
