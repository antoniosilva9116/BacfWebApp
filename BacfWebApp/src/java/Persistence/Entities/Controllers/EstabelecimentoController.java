...
public class EstabelecimentoController implements Serializable {
    ...
    private Estabelecimento current;
    ...
    public Estabelecimento getSelected() {
        if (current == null) {
            current = new Estabelecimento();
            selectedItemIndex = -1;
        }
        return current;
    }

    public void setSelected(Estabelecimento current) {
    ...
    public String prepareView() {
        current = (Estabelecimento) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("EstabelecimentoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("EstabelecimentoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("EstabelecimentoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Estabelecimento getEstabelecimento(java.lang.Integer id) {
    ...
    public static class EstabelecimentoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Estabelecimento) {
                ...
                return getStringKey(o.getEstabelecimentoID());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Estabelecimento.class.getName());
            }
        }
